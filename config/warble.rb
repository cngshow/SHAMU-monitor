...
Warbler::Config.new do |config|
  ...
  ####TO Do I might need this!!!!!!!
  #config.java_libs += FileList["lib/lib/*.jar"]
  ...
  #adding that line below does not force them in
  #"lib/lib/commons-exec-1.1.jar","lib/lib/jcl-over-slf4j-1.6.4.jar", "lib/lib/jruby-complete-1.6.7.2.jar", "lib/lib/metrics-data-service.jar", "lib/lib/ojdbc6.jar", "lib/lib/quartz-all-2.1.0.jar", "lib/lib/shamu_quartz.jar", "lib/lib/slf4j-api-1.6.4.jar", "lib/lib/slf4j-jdk14-1.6.4.jar", "lib/lib/ucp.jar",
  config.includes = FileList["warble.bat", "bundle_install.bat", "bundle_update.bat", "database_trim.bash", "database_trim.bat", "deployment_tasks.txt", "devise_install.txt", "execute_job.bash", "execute_job.bat", "Gemfile", "Gemfile.lock", "introscope_alerts.bash", "introscope_alerts.bat", "kill_shamu.bash", "last_known_jle_status.bash", "last_known_jle_status.bat", "prep_for_checkin.rb", "prepare_escalations.bash", "prepare_escalations.bat", "pst_dashboard.properties", "quartz.properties", "rename_job_code.bash", "Rakefile", "rename_job_code.bat", "repair_escalations.bash", "repair_escalations.bat", "shamu_env.bash", "shutdown.bat", "shamu_quartz_log.properties", "startup.bash", "startup.bat"]
  config.excludes = FileList["tmp/cache", "tmp/pids", "tmp/sessions", "tmp/sockets", "zzz_old_code"]
